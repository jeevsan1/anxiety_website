    ...
    return (
        ...
        <div className={Style.anxiety_disorder}>
            ...
            <h1> <ul>
                ...
                <li>Obsessive-Compulsive Disorder (OCD)- This disorder is characterized by recurrent, unwanted thoughts and the people who have it try to do 'rituals' to get rid of these thoughts but it's only temporary </li>
        ...
        <img src="img(3).jpg" alt="Anxiety"></img>
        </div>
