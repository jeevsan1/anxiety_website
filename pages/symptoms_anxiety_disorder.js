    ...
    return (
        ...
        <div className={Style.anxiety_disorder}>
            ...
            <h1> <ul>
                ...
                <li>Obsessive-Compulsive Disorder (OCD)- Recurrent, unwanted thoughts and the people who have it try to do 'rituals' to get rid of these thoughts but it's only temporary </li>
        ...
        <img src="img(4).jpg" alt="Anxiety"></img>
        </div>
